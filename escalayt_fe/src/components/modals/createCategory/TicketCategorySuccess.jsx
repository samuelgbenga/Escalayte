...
function TicketCategorySuccess({ onClose }) {
  return (
    <>
          ...
          <div className="w-[352px] flex flex-col gap-1">
            ...
            <div className="h-[60px] flex items-center">
              <p className="text-[14px] font-normal leading-[20px] text-[#475467] text-left">
                Your new ticket category has been created and is now available
                for use. You can start assigning tickets to this category
                immediately.
              </p>
            </div>
          </div>
...
export default TicketCategorySuccess;
